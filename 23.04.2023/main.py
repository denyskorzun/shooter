...
class Button(sprite.Sprite):
    def __init__(self, x, y, width, height, color, text):
        super().__init__()
        self.text = font2.render(text, 1, (255, 255, 255))
...
lose = font2.render("ВИ ПРОГРАВ", True, (255, 50, 25))
...
btn = Button(250, 250, 190, 80, (25, 255, 25), "Почати заново")
...
while run:
    ...
    if not finish:
        ...
        if score >= 10:
            text_win = font2.render("Ви перемогли", 1, (255, 255, 255))
            window.blit(text_win, (win_width // 2 - lose.get_width() // 2, win_height // 2 - lose.get_height()))
        else:
            text_lose1 = font2.render("Ви програли", 1, (255, 255, 255))
            window.blit(text_lose1, (win_width // 2 - lose.get_width() // 2, win_height // 2 - lose.get_height()))
        btn.draw()
        btn.on_click()      
    # else:
    #     if is_win:
    #         pass
    #     else:
    #         window.blit(lose, (win_width // 2 - lose.get_width() // 2, win_height // 2 - lose.get_height()))
